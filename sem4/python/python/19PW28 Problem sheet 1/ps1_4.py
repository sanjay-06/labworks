...
def findperson(instrument):
    ...
    return list(dict.keys()),dict                           #returning the instrument users

string=input("Enter the instrument: ")
key,dict=findperson(string)
print("The instrument {} is played by {} and the dictionary is {}".format(string,",".join(key),dict))
